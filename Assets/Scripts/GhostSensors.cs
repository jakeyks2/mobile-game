...
public class GhostSensors : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            ghostDistance = Vector3.Distance(xrCamera.transform.position, ghostSpawner.ghost.transform.position);
            ...
            float ghostAngle = Vector3.Angle(xrCamera.transform.forward, (ghostSpawner.ghost.transform.position - xrCamera.transform.position).normalized);
